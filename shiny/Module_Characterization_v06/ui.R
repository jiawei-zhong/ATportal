                      ...
                      tabsetPanel(
                        tabPanel("Input",     
                                 ...
                                 conditionalPanel(
                                   ...
                                   materialSwitch(inputId = "prot_switch", label = "Add proteomics plots", status="primary"),
                                   br(),
                                   selectInput("cell_line", "Select adipose tissue derived stem cell line", choices = c("hAT MSC", "SGBS")),
                                 ),
